...
void window_init(uint8_t reason)
{
  ...
  {
  	GrContextFontSet(&context, &g_sFontMetroid32);
  	GrStringDrawCentered(&context, "SMART", -1, 72 , 30, 0);
  	GrStringDrawCentered(&context, "WATCH", -1, 72 , 60, 0);
  	GrContextFontSet(&context, &g_sFontHelvetic20);
  	GrStringDrawCentered(&context, "Viewcooper", -1, 72 , 110, 0);
